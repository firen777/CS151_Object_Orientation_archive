...
public class Telephone
{
   ...
   */
   public Telephone()
   {
      ...
      scrollerSpeaker = new JScrollPane(speakerField);
      
      speakerPanel.add(scrollerSpeaker,
         BorderLayout.CENTER);
      ...
      scrollerPhone = new JScrollPane(microphoneField);
      ...
      microphonePanel.add(new JLabel("Microphone:"),
         BorderLayout.NORTH);
      microphonePanel.add(scrollerPhone,
         BorderLayout.CENTER);
   ...
   */
   ...
   private JScrollPane scrollerPhone;
   private JScrollPane scrollerSpeaker;
